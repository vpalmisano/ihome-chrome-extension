(function($) {
  ...
  var RSS = function(target, url, options, callback) {
    ...
    this.options = $.extend({
      ...
      effect: 'show',
      error: function(e) {
        console.log("jQuery RSS error:", e);
      },
      success: function(){}
    }, options || {})
  ...
  RSS.prototype.render = function() {
    ...
    this.load(function(data) {
      try {
        self.title = data.responseData.feed.title
        self.description = data.responseData.feed.description
        self.link = data.responseData.feed.link
        self.entries = data.responseData.feed.entries
      } catch(e) {
        self.entries = []
        self.title = self.description = self.link = ''
        return self.options.error.call(self, e)
      }
  ...
  RSS.prototype.generateHTMLForEntries = function() {
    ...
    if(!!this.options.entryTemplate) {
      ...
      var t = this.options.layoutTemplate.replace('{title}', this.title)
      if(this.link)
          t = t.replace('{link}', this.link);
      if(this.description)
        t = t.replace('{description}', this.description);
      result.layout = this.wrapContent(t.replace("{entries}", "<entries></entries>"))
    } else {
